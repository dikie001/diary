...
const About = () => {
 ...
 <Navbar/>
    <div className="flex-grow p-6 overflow-y-auto h-dvh flex flex-col items-center justify-center bg-gradient-to-b from-indigo-800 via-blue-600 to-violet-700 px-6">
      ...
      <div className="max-w-3xl text-center text-white bg-black/20 backdrop-blur-md p-8 rounded-lg shadow-lg">
        <h2 className="text-5xl font-extrabold tracking-wide">About WhisperNote</h2>
